...
void main() 
{
	...
	texture(s_screenTex,vec2(inUV.x,inUV.y-heightAdds[2]))*gaussNumbers[2]+texture(s_screenTex,vec2(inUV.x,inUV.y+heightAdds[2]))*gaussNumbers[2]+
	texture(s_screenTex,vec2(inUV.x,inUV.y-heightAdds[3]))*gaussNumbers[3]+texture(s_screenTex,vec2(inUV.x,inUV.y+heightAdds[3]))*gaussNumbers[3]+
